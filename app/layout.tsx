...
export const metadata: Metadata = {
  ...
  description: "A platform for developers to share, upvote, and discuss innovative projects.",
};
...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <body className={`${workSans.variable} font-work-sans bg-slate-50 antialiased`}>
        {children}
      </body>
